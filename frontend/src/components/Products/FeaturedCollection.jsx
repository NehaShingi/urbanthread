    ...
    <section className="py-12 px-4 lg:px-0">
      <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center bg-gray-100 rounded-3xl">
        ...
        <div className="lg:w-1/2 p-8 text-center lg:text-left">
          <h2 className="text-lg font-semibold text-fray-700 mb-2">
            Comfort and Style
          </h2>
          <div className="w-20 h-1 bg-red-600 mt-3 mb-8 rounded-full mx-auto lg:mx-0"></div>
          ...
          <Link
            to="/collections/all"
            className="bg-black text-white px-6 py-3 rounded-lg text-lg hover:bg-gray-800 hover:bg-red-500 transition-colors duration-300"
          >
            Shop Now
          </Link>
        </div>
